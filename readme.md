...
### composer dev
<hr>
### api url link : http://company-livewire.test/api/companies/1 <br/>
...
![alt text](https://github.com/neet91/company-livewire/blob/main/storage/screenshot/4.api-response.png)
